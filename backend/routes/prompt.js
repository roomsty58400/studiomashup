...
async function listGeminiModels(apiKey) {
  ...
  // Garde uniquement les modèles qui supportent generateContent, préfère flash
  return (data.models || [])
...
// chaque "Prompt Suno" généré.
let cachedWorkingModel = null;

// Modèles connus pour avoir du quota gratuit sur la plupart des comptes —
// essayés avant la liste complète, pour éviter l'appel de découverte
// (listGeminiModels) sur le chemin le plus courant.
...
async function callGemini(apiKey, userPrompt) {
  ...
  // Repli : liste complète des modèles disponibles sur le compte (au cas où
  // les modèles prioritaires ne sont plus dispo / plus de quota nulle part).
